  ...
  return (
    <View style={[globalStyle.container, {backgroundColor: '#D5EDE3'}]}>
      ...
      <ScrollView >      
        ...
        <Text style={[globalStyle.fontMedium, { textAlign:'justify', marginVertical: 10, marginHorizontal: '10%', fontSize: 16}]} >
          36, Dilkusha C/A, Peoples Insurance Bhaban (17th Floor) Dhaka -1000, Tel: 9577534-38
        </Text>

        <View style={{flexDirection:'row', justifyContent:'space-around', width:'80%', alignItems:'center', alignSelf:'center', marginTop:20}}>
